...
from monitor.lib.colors import blue, reset, yellow
...
def next_steps(branch, main_branch):
    """Print diff, branch summary, and suggested next steps for a feature branch.

    Args:
        branch: Feature branch to analyze.
        main_branch: Base branch to compare against.
