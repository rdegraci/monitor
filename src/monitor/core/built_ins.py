    ...
    command_groups: List[Dict[str, Any]] = [
        ...
        },
        {
            ...
            "commands": [
                ...
                {
                    "command": "symbols",
                    "function": _make_callable(symbols_command),
                    "description": "Show symbol-tool readiness, supported languages, and cache/session counters. Usage: :symbols [cache|langs].",
                },
            ],
        },
        {
