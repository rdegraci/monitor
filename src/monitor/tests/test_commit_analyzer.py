...
@patch('lib.commit_analyzer.litellm.completion')
@patch('lib.commit_analyzer.perform_git_show')
@patch('lib.commit_analyzer.perform_git_log_range')
def test_analyze_commits_summary_and_next_steps(mock_log_range, mock_show, mock_litellm):
    ...
    logger = logging.getLogger('lib.commit_analyzer.test')
...
@patch('lib.commit_analyzer.yaml.safe_load', return_value={'branch_name': 'abc', 'main_branch': 'main'})
@patch('builtins.open')
...
@patch('lib.commit_analyzer.yaml.safe_load', side_effect=Exception('fail'))
...
@patch('lib.commit_analyzer.perform_git_diff_staged', return_value='sample-diff')
@patch('lib.commit_analyzer.recursive_macro_expand', side_effect=lambda c, v, o, cl, e: c)
