...
## Purpose
Treat this document as the authoritative operating manual. When you reason about the repository, summarize it, choose files, or make changes, obey these rules exactly so the result stays deterministic, traceable, and easy for tools to verify.
